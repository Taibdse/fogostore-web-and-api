...
<%--    <base href="https://fogostore.com" />--%>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="${shop.logo}">
    <%--    Social Media Friendly--%>
    <meta property="og:title" content="${pageMetadata.title}">
    <meta property="og:description" content="${pageMetadata.description}">
    <meta property="og:image" content="http://fogostore.com${pageMetadata.image}">
    <meta property="og:image:secure_url" content="https://fogostore.com${pageMetadata.image}">
    ...
    <meta property="og:site_name" content="Phụ Tùng Đồ Chơi MoTor Fmanracing">
    <meta property="og:url" content="https://fogostore.com${requestScope['javax.servlet.forward.request_uri']}" />
    ...
    <meta property="twitter:url" content="https://fogostore.com${requestScope['javax.servlet.forward.request_uri']}">
