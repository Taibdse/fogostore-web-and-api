                ...
                <div id="home-wrap" class="content-section">
                    ...
                    <div class="container">
                        <div class="row no-margin wrap-text padding-onlytop-lg">
                            <div class="col-md-12 padding-leftright-null">
                                <div class="text small padding-top-null">
                                    <img src="assets/img/project1.jpg" alt="" class="img-post">
                                </div>
                            </div>
                         </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row no-margin wrap-text padding-onlybottom-lg">
                            <div class="col-md-6 padding-leftright-null">
                                <div class="text small padding-top-null">
                                    <img src="assets/img/project2.gif" alt="" class="img-post">
                                </div>
                            </div>
                            <div class="col-md-6 padding-leftright-null">
                                <div class="text small padding-top-null">
                                    <img src="assets/img/project3.jpg" alt="" class="img-post">
                                </div>
                            </div>
                        </div>
                    </div>
