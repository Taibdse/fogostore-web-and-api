                ...
                <div id="home-wrap" class="content-section">
                    ...
                    <div class="container">
                        <div class="row no-margin wrap-text padding-onlytop-lg padding-onlybottom-lg">
                            <div class="col-md-4 padding-leftright-null">
                                <div class="text small padding-top-null">
                                    <h2 class="heading margin-bottom-extrasmall">See what your<br>costumer says<span class="color">.</span></h2>
                                </div>
                            </div>
                            <div class="col-md-8 padding-leftright-null">
                                <div class="row no-margin">
                                    <!-- Testimonials -->
                                    <section class="testimonials-carousel-single">
                                        <div class="item padding-leftright-null">
                                            <div class="text small overflow-hidden padding-top-null">
                                                <div class="person">
                                                    <div class="description">
                                                        <em>Anna Brown</em>
                                                        <span>CEO at Index.com</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="item padding-leftright-null">
                                            <div class="text overflow-hidden small padding-top-null">
                                                <div class="person">
                                                    <div class="description">
                                                        <em>Susan Tril</em>
                                                        <span>Designer at Pink.com</span>
                                                    </div>
                                                </div>
                                                <blockquote>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </blockquote>
                                            </div>
