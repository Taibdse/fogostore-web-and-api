        ...
        <div id="main-wrap">
            ...
            <div id="page-content">
                   ...
                   <div class="row no-margin wrap-slider">
                       <div class="col-md-6 padding-leftright-null">
                           <div id="flexslider" class="home">
                               <ul class="slides">
                                   <li style="background-image:url(assets/img/slider-creative.jpg)"></li>
                                   <li style="background-image:url(assets/img/slider-creative-2.jpg)"></li>
                               </ul>
                           </div>
                       </div>
                       <div class="col-md-6 padding-leftright-null">
                           <div id="home-slider" class="secondary-background">
                               <div class="text">
                                   <h1 class="white margin-bottom">Creative<br>Studio<span>.</span></h1>
                ...
                <div id="home-wrap" class="content-section">
                    ...
                    <div class="container">
                        <div class="row no-margin">
                            <div class="col-md-12 padding-leftright-null text-center">
                                <i class="icon ion-ios-keypad color separator margin-bottom-small"></i>
                            </div>
                        </div>
                    </div>
                    <!-- END Separator -->
                    <div class="container">
                        <!--  Portfolio  -->
                        <section id="projects" data-isotope="load-simple" class="page padding-top-null">
                            <!--  Filters  -->
                            <div class="row no-margin text-center text-sm-left">
                            ...
                            <div class="projects-items equal three-columns">
                                ...
                                <div class="single-item styled one-item design branding">
                                    <div class="item">
                                        ...
                                        <a href="project-1.jsp" class="link"></a>
                                    </div>
                                </div>
                                <!-- END Single Project -->
                                <div class="single-item styled one-item branding web">
                                    <div class="item">
                                        ...
                                        <a href="project-2.jsp" class="link"></a>
                                    </div>
                                </div>
