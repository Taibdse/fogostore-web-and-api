                    ...
                    <div class="row no-margin wrap-slider padding-leftright-null">
                       <div class="col-md-6 padding-leftright-null">
                           <a class="popup-youtube" href="https://www.youtube.com/watch?v=4PFBxfITU_Q">
                               <div class="bg-img home" style="background-image:url(assets/img/slider.jpg)"></div>
                           </a>
                       </div>
                       <div class="col-md-6 padding-leftright-null">
                        ...
                        <div class="row no-margin padding-lg">
                            <div class="col-md-4 padding-leftright-null">
                                <div class="text first padding-top-null">
                                    <h2 class="heading margin-bottom-extrasmall">Wellcome to our<br>studio<span class="color">.</span></h2>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4 single-news styled">
                                    <article>
                                        <div class="content">
                                            ...
                                            <a href="single-post.jsp" class="btn-pro">Read more</a>
                                        </div>
                                    </article>
                                </div>
                                <!-- END Single News -->
                                <div class="col-sm-4 single-news styled">
                                    <article>
                                        <div class="content">
                                            ...
                                            <h3>Brand Power</h3>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                            <a href="single-post-slider.jsp" class="btn-pro">Read more</a>
                                        </div>
                                    </article>
                                </div>
                                <div class="col-sm-4 single-news styled">
                                    <article>
                                        <div class="content">
                                            ...
                                            <h3>Our Sale</h3>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                            <a href="single-post-video.jsp" class="btn-pro">Read more</a>
                                        </div>
                                    </article>
                                </div>
                            </div>
