            ...
            <div id="page-content">
                ...
                <div class="container">
                   <div class="row no-margin">
                       <div class="col-md-12 padding-leftright-null">
                           <div id="page-header">
                               <div class="text">
                                   <h1 class="margin-bottom-small">Services<span class="color">.</span></h1>
                ...
                <div id="home-wrap" class="content-section">
                    <div class="container">
                        ...
                        <div class="row no-margin">
                            <div class="text">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut aliquid scire se gaudeant? <b>Immo alio genere;</b> <i>Quod vestri non item.</i> Duo Reges: constructio interrete. Est enim effectrix multarum et magnarum voluptatum. Sed quanta sit alias, nunc tantum possitne esse tanta. <i>Sint ista Graecorum;</i> Consequens enim est et post oritur, ut dixi. </p>
                                ...
                                <div class="row padding-sm margin-leftright-null">
                                    <div class="col-xs-6 col-sm-3  padding-sm">
                                        <a href="#" class="btn-alt small border margin-null">Button</a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3  padding-sm">
                                    ...
                                    <div class="col-md-12 padding-leftright-null">
                                        <div class="col-md-4">
                                            <div class="margin-md-bottom">
                                                ...
                                                <h3 class="margin-bottom-small">Business Goals</h3>
                                        ...
                                        <div class="col-md-4">
                                            <div class="margin-md-bottom">
                                                ...
                                                <h3 class="margin-bottom-small">Professional Team</h3>
                                                <p class="margin-bottom-null">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem harum aspernatur sapiente error, voluptas fuga, laudantium ullam magni fugit. Qui!</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div>
                                                ...
                                                <h3 class="margin-bottom-small">Vision</h3>
                                                <p class="margin-bottom-null">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem harum aspernatur sapiente error, voluptas fuga, laudantium ullam magni fugit. Qui!</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body">
                                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo officia voluptates hic obcaecati voluptatum omnis, nihil nam numquam nisi esse praesentium iure consectetur dolorum porro a sequi veniam eligendi similique! Ab atque aliquam error eius natus repellendus voluptatibus dolore blanditiis.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                    <div class="panel-body">
                                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea reprehenderit atque labore, eos ad dolorem officia ut ex vero, totam assumenda, sapiente enim. Iusto, aliquid recusandae maiores enim deleniti fuga obcaecati placeat iste, libero, aut quos, officiis laborum nesciunt similique!
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                                    <div class="panel-body">
                                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur facere omnis tempore, atque, dolorum aperiam eligendi dignissimos quis? Alias itaque soluta dolorem dignissimos velit sint, dolores delectus, voluptatem animi molestiae atque voluptates, ab eius unde, voluptate totam? Illo, quasi, facilis.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!--  END Alerts  -->
                                <!--  Modal  add modaal.min.css and modaal.min.js -->
                                <div class="row padding-md">
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="#modaal" class="inline btn-alt small active margin-null">Modal Text</a>
                                        <div id="modaal">
                                            <div class="row no-margin content-section">
                                                <div class="text">
                                                    <h2 class="margin-bottom-null title left">Modal Only text</h2>
                                                    <div class="row padding-onlytop-md">
                                                        <div class="col-md-12">
                                                            <p class="margin-null">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum nesciunt eveniet ducimus ad, dolor, inventore dignissimos! Voluptas quae odit vitae, quasi impedit, ratione est et.</p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="#modaalImage" class="inline btn-alt small active margin-null">Modal Image</a>
                                        <div id="modaalImage">
                                            <img src="assets/img/item8.jpg" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="#modaalContent" class="inline btn-alt small active margin-null">M. Services</a>
                                        <div id="modaalContent">
                                            <div class="row no-margin content-section">
                                                <div class="col-md-12 padding-leftright-null">
                                                    ...
                                                    <div class="col-md-4 padding-leftright-null">
                                                        <div class="text padding-md-bottom-null">
                                                            <i class="icon ion-ios-color-filter-outline service color"></i>
                                                            <h3 class="margin-bottom-small">Professional Team</h3>
                                                            <p class="margin-bottom-null">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem harum aspernatur sapiente error, voluptas fuga, laudantium ullam magni fugit. Qui!</p>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <!--  Pricing  -->
                                    <div class="col-md-12 padding-leftright-null">
                                        <div id="pricing" class="padding-onlytop-md">
                                            <div class="col-md-4 padding-leftright-null">
                                                <div class="price margin-md-bottom">
                                                    <div class="price-title">Business</div>
                                                    <div class="price-number">$25</div>
                                                    <div class="price-rate">per mounth</div>
                                                    <ul>
                                                        <li><b>12 Gb</b> Storage</li>
                                                        <li><b>1</b> Commercial Site</li>
                                                        <li><b>No</b> Backup</li>
                                                        <li><b>12 hours</b> support</li>
                                                    </ul>
                                                    <a href="#" class="btn-alt small shadow">Get Started</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4 padding-leftright-null">
                                                <div class="price active margin-md-bottom">
                                                    <div class="price-title">Enterprice</div>
                                                    <div class="price-number">$50</div>
                                                    <div class="price-rate">per mounth</div>
                                                    <ul>
                                                        <li><b>Unlimited</b> Storage</li>
                                                        <li><b>Unlimited</b> Commercial Site</li>
                                                        <li><b>Yes</b> Backup</li>
                                                        <li><b>24 hours</b> support</li>
                                                    </ul>
                                                    <a href="#" class="btn-alt small shadow">Get Started</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4 padding-leftright-null">
                                                <div class="price margin-md-bottom">
                                                    <div class="price-title">Exclusive</div>
                                                    <div class="price-number">$150</div>
                                                    <div class="price-rate">per mounth</div>
                                                    <ul>
                                                        <li><b>Unlimited</b> Storage</li>
                                                        <li><b>Unlimited</b> Commercial Site</li>
                                                        <li><b>Double</b> Backup</li>
                                                        <li><b>100 hours</b> support</li>
                                                    </ul>
                                                    <a href="#" class="btn-alt small shadow">Get Started</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <ul class="skill-list">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="label secondary-background"><span class="count" data-to="25"></span>%</span>
                                                </li>
                                                <em class="black">Branding</em>
                                                <li class="margin-null">
                                                    <span class="border-color" data-percent="75%"></span>
                                                    <span class="label secondary-background"><span class="count" data-to="75"></span>%</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <ul class="skill-list">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="label secondary-background"><span class="count" data-to="45"></span>%</span>
                                                </li>
                                                <em class="black">Marketing</em>
                                                <li class="margin-null">
                                                    <span class="border-color" data-percent="85%"></span>
                                                    <span class="label secondary-background"><span class="count" data-to="85"></span>%</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </section>
